package com.mashkario.backuper.azure.func.module;
...
import com.mashkario.backuper.azure.func.service.SyncMdPersistenceMapper;
...
public class SyncModule {
    ...
    @Provides
    @Singleton
    public SyncMdPersistenceMapper providesSyncMdPersistenceMapper(){
        return new SyncMdPersistenceMapper();
    }
